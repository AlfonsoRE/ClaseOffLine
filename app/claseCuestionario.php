...
<div id="content" class="container">
    ...
    <h2>Descripción del Cuestrionario</h2>
    <br>
    <div class="main-layout">
        ...
        <div class="content-column">
            <div ng-repeat="tema in temas" class="">
                <!-- TAREAS -->
                <div ng-repeat="cues in tema.cuestionarios" class="contenido-preview" ng-click="cues.id==id_buscarcuestionario">
                    <div class="media">
                        <div class="cuestionario-card" ng-repeat="cues in tema.cuestionarios">
